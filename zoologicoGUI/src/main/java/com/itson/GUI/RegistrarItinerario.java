...
public class RegistrarItinerario extends javax.swing.JFrame {
    ...
    private static RegistrarItinerario registrarItinerario;

    public static RegistrarItinerario obtenerInstancia() {

        if (registrarItinerario == null) {
            RegistrarItinerario registrarItinerario = new RegistrarItinerario();
            return registrarItinerario;
        }
        return registrarItinerario;
    }

    private RegistrarItinerario() {
        initComponents();
    }
